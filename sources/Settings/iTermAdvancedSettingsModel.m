...
DEFINE_BOOL(showMenuBarItem, NO, SECTION_GENERAL @"Show iTerm2 icon in the menu bar?\nWhen enabled, a status bar icon appears in the system menu bar regardless of whether iTerm2 is excluded from the dock. The icon shows a count badge when AI chat agents are working.");
